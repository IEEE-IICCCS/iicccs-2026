...
export const routes: Routes = [
  ...
  { path: 'author-guidelines', loadComponent: () => import('./pages/author-guidelines/author-guidelines.component').then(m => m.AuthorGuidelinesComponent) },
  { path: 'call-for-papers', loadComponent: () => import('./pages/call-for-papers/call-for-papers.component').then(m => m.CallForPapersComponent) },
